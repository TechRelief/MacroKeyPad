...
#define DEVICE_NAME "MacroPad"
#define US_KEYBOARD
//#define KEY_SYSRQ 0x46 // Keyboard Print Screen <TR: Not sure why this was defined as KEY_SYSRQ if it is the print screen code>
#define KEY_PRTSCRN 0x46 // Keyboard Print Screen
...
#define CAP_LK_LED D0
#define NUM_LK_LED D1
#define SCR_LK_LED D2
